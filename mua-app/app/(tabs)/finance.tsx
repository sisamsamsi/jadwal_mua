...
import { TrendingUp, TrendingDown, Receipt, Plus, ChevronRight, PieChart, Wallet } from "lucide-react-native";
    ...
    <SafeAreaView className="flex-1 bg-background">
      <ScrollView contentContainerStyle={{ padding: 24 }}>
        <View className="mb-8">
          ...
          <Text className="text-text-secondary">Kelola pendapatan dan pengeluaran Anda</Text>
        </View>
        ...
        {/* Quick Actions - INI JAWABAN PERTANYAAN ANDA */}
        <View className="flex-row gap-x-4 mb-8">
           <TouchableOpacity 
             onPress={() => router.push("/payment/new")}
             className="flex-1 bg-white p-4 rounded-2xl border border-divider items-center shadow-sm"
           >
              <View className="w-12 h-12 bg-green-100 rounded-full items-center justify-center mb-2">
                 <TrendingUp size={24} color="#4CAF50" />
              </View>
              <Text className="font-bold text-text-primary text-xs uppercase">Catat</Text>
              <Text className="font-bold text-text-primary text-xs uppercase">Pemasukan</Text>
           </TouchableOpacity>
           ...
           >
              ...
              <Text className="font-bold text-text-primary text-xs uppercase">Catat</Text>
              <Text className="font-bold text-text-primary text-xs uppercase">Pengeluaran</Text>
           </TouchableOpacity>
        </View>
